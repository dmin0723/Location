...
import com.dengmin.location.activity.MainActivity;
import com.dengmin.location.utils.map.MyOrientationListener;
...
public class MapFragment extends Fragment implements ScreenShotable {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //设置背景图片
        rootView.setBackgroundResource(R.drawable.map_background);
        //初始化地图控件
    ...
    public class MyLocationListener implements BDLocationListener
    {
        ...
        public void onReceiveLocation(BDLocation location)
        {
            ...
            // 构造定位数据
            MyLocationData locData = new MyLocationData.Builder()
                    .accuracy(location.getRadius()) //精确度
                    // 此处设置开发者获取到的方向信息，顺时针0-360
                    .direction(mXDirection)
    ...
    public void takeScreenShot() {
        Thread thread = new Thread() {
            ...
            public void run() {
                ...
                Bitmap bitmap = Bitmap.createBitmap(mapContainer.getWidth(), mapContainer.getHeight(), Bitmap.Config.ARGB_8888);
